...
// [CH] 以下变量请根据空间商提供的账号参数修改,如有疑问,请联系服务器提供商
	...
	$dbuser = 'wooley';			// database username
						// 数据库用户名

	$dbpw = 'j8Do6K0g3p';			// database password
						// 数据库密码

	$dbname = 'wooley';			// database name
						// 数据库名
...
// [CH] 如您对 cookie 作用范围有特殊要求,或游戏登录不正常,请修改下面变量,否则请保持默认
...
// [CH] 切勿修改以下变量,仅供程序开发调试用!
	...
	$bbsurl = 'http://wooley.me';    //the bbs url for the game plus
									//安装游戏插件的论坛地址

	$gameurl = 'http://wooley.me';    // the url of game program files,for the full-window mode
									//游戏程序地址，用于全屏模式

	$homepage = 'http://wooley.me';      // game homepage
									//官方网站地址
